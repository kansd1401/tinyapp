...
app.post("/urls", (req, res) => {
  ...
  let templateVars ={}
  templateVars = { shortURL: randomString, longURL: urlDatabase[randomString]['longURL'], username: users[req.session.user_id]['email'] };
...
app.get("/login", (req, res) => {let templateVars ={}
  if(req.session.user_id === undefined){
    ...
    templateVars = { urls: urlDatabase ,username: users[req.session.user_id]['email']};
  }
...
app.get("/urls", (req, res) => {
  ...
  if(req.session.user_id === undefined){
    ...
    templateVars = { urls: urlsForUser(req.session.user_id) ,username: users[req.session.user_id]['email']};
  }
...
app.get("/urls/:shortURL", (req, res) => {
  ...
  if(req.session.user_id === undefined){
    ...
    templateVars = { shortURL: req.params.shortURL, longURL: urlDatabase[req.params.shortURL]['longURL'] ,username: users[req.session.user_id]['email']};
  }
  res.render("urls_show", templateVars);
});
